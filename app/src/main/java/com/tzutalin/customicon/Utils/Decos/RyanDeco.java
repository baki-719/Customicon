...
public class RyanDeco extends Deco{
    ...
    public void init() {
        ...
        emoEyebrows[0].setSlope(settingValue.getEyebrowSlope(1));
//        emoEyebrows[0].setLength(10);
        emoEyebrows[1].setSlope(settingValue.getEyebrowSlope(2));
//        emoEyebrows[1].setLength(10);
        emoEyebrows[2].setSlope(settingValue.getEyebrowSlope(3));
//        emoEyebrows[2].setLength(10);
        emoEyebrows[3].setSlope(settingValue.getEyebrowSlope(4));
//        emoEyebrows[3].setLength(10);
        ...
        emoNoses[0].setHeight(settingValue.getNoseHeight(1));
        emoNoses[0].setWidth(settingValue.getNoseWidth(1));
        emoNoses[1].setHeight(settingValue.getNoseHeight(2));
        emoNoses[1].setWidth(settingValue.getNoseWidth(2));
        emoNoses[2].setHeight(settingValue.getNoseHeight(3));
        emoNoses[2].setWidth(settingValue.getNoseWidth(3));
        emoNoses[3].setHeight(settingValue.getNoseHeight(4));
        emoNoses[3].setWidth(settingValue.getNoseWidth(4));
        for(int i = 0 ; i < 4; i++) {
